...
const useStyles = makeStyles(theme => ({
	...
	card: {
		maxWidth: 350,
		background: 'linear-gradient(45deg, #33FFF0 20%, #33B5FF 90%)'
	},
	imagePoke: {
		height: 250
	}
		...
		<>
			...
			<AppBar color='secondary'>
				<Toolbar>
					...
					<Typography style={{ flexGrow: 1 }}>Poke App</Typography>
			...
			<footer className={classes.footer}>
				<Container maxWidth='sm'>
					<Typography align='center'>PokeAPP © {new Date().getFullYear()}</Typography>
				</Container>
			</footer>
		</>
	)
